> **Nota**: Não esqueça de por o token de login do seu bot do discord em https://discord.com/developers/applications em config.json troque pelo token do seu bot.
# BackLinks
